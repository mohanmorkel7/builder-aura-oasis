    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <Button variant="ghost" onClick={() => navigate(`/product/deployment/${id}`)}>
        ...
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div>
              ...
              <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(deployment.status)}`}>
                {deployment.status.charAt(0).toUpperCase() + deployment.status.slice(1).replace('_', ' ')}
              </div>
            </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Select value={deployment.product} onValueChange={(value) => updateField('product', value)}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="Core App">Core App</SelectItem>
                      <SelectItem value="Analytics Module">Analytics Module</SelectItem>
                      <SelectItem value="API Gateway">API Gateway</SelectItem>
                      <SelectItem value="Mobile App">Mobile App</SelectItem>
                      <SelectItem value="Reporting Service">Reporting Service</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Select value={deployment.environment} onValueChange={(value) => updateField('environment', value)}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Automatically rollback if deployment fails</p>
                  </div>
                  <Switch
                    checked={deployment.autoRollback}
                    onCheckedChange={(checked) => updateField('autoRollback', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Run health checks after deployment</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Send notifications on status changes</p>
                  </div>
                  <Switch
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          if (newKey !== key) {
                            ...
                            setDeployment(prev => ({ ...prev, variables: newVars }));
                            setHasChanges(true);
                          }
                        }}
