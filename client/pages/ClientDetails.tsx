...
const mockOnboardingProgress = [
  { name: 'Initial Contact', status: 'completed', completed_date: '2024-06-15' },
  { name: 'Proposal Sent', status: 'completed', completed_date: '2024-06-20' },
  { name: 'Document Collection', status: 'in_progress', due_date: '2024-07-15' },
    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">{clientData.client_name}</h1>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track the client onboarding workflow</CardDescription>
            </CardHeader>
            <CardContent>
