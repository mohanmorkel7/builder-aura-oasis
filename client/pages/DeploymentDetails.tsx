...
import { useDeploymentControl, useDeploymentStatus } from '@/hooks/useDeploymentControl';
...
const mockDeployment = {
  ...
  description: 'Major feature release including new dashboard widgets and performance improvements',
  steps: [
    ...
    { name: 'Run Integration Tests', status: 'in_progress', duration: '3m 20s' },
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <Button variant="outline" onClick={() => navigate(`/product/deployment/${id}/edit`)}>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-semibold text-gray-900">{deployment.deployedBy}</p>
              </div>
      ...
      {currentStatus === 'in_progress' && (
        <Alert>
          ...
          <AlertDescription className="flex items-center justify-between">
            <span>Deployment is currently running. You can pause, stop, or monitor the progress.</span>
      ...
      {currentStatus === 'failed' && (
        <Alert variant="destructive">
          ...
          <AlertDescription className="flex items-center justify-between">
            <span>Deployment failed. You can retry the deployment or check the logs for more details.</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{new Date(deployment.startedAt).toLocaleString()}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{new Date(deployment.estimatedCompletion).toLocaleString()}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <Button className="w-full justify-start" variant="outline" onClick={() => handleAction('rollback')}>
                  <RotateCcw className="w-4 h-4 mr-2" />
                  Rollback Deployment
                </Button>
                <Button className="w-full justify-start" variant="outline" onClick={() => handleAction('promote')}>
                  <Rocket className="w-4 h-4 mr-2" />
                  Promote to Production
                </Button>
                <Button className="w-full justify-start" variant="outline" onClick={() => navigate('/product/deployment/new')}>
        ...
        <TabsContent value="steps" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track the progress of each deployment step</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="settings" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>View and modify deployment settings</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
