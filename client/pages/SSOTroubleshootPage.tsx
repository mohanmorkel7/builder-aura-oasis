...
export default function SSOTroubleshootPage() {
  ...
  const openAzurePortal = () => {
    const azureUrl = 'https://portal.azure.com/#view/Microsoft_AAD_RegisteredApps/ApplicationMenuBlade/~/CallAnAPI/appId/d982ffb1-9734-4470-bf4d-1b23b434edd3';
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">SSO Troubleshooting</h1>
          ...
          {user ? (
            <div className="space-y-3">
              ...
              <div className="p-3 bg-gray-50 rounded-lg text-sm">
                ...
                <p><strong>Auth Method:</strong> {user.azureObjectId ? 'Microsoft SSO' : 'Demo Login'}</p>
              </div>
              {user.azureObjectId ? (
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="p-3 bg-blue-50 rounded-lg text-sm">
            ...
            <p><strong>Client ID:</strong> d982ffb1-9734-4470-bf4d-1b23b434edd3</p>
            <p><strong>Tenant ID:</strong> 13ae5dfc-2750-47cb-8eca-689b5bc353b6</p>
          </div>
          
          <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg text-sm">
            <p className="font-medium text-yellow-800 mb-2">Required Permissions:</p>
          ...
          <Button onClick={openAzurePortal} variant="outline" className="w-full">
        ...
        <CardContent>
          <div className="space-y-4 text-sm">
            <div className="p-3 bg-blue-50 rounded-lg">
              <h4 className="font-medium text-blue-800 mb-2">🔄 Method 1: Clear & Retry</h4>
            ...
            <div className="p-3 bg-green-50 rounded-lg">
              <h4 className="font-medium text-green-800 mb-2">🔧 Method 2: Re-verify Azure AD</h4>
            ...
            <div className="p-3 bg-purple-50 rounded-lg">
              <h4 className="font-medium text-purple-800 mb-2">🧪 Method 3: Direct Test</h4>
      ...
      <Card>
        ...
        <CardContent>
          <div className="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm max-h-64 overflow-y-auto">
            {logs.length === 0 ? (
              <p className="text-gray-500">No logs yet. Try the troubleshooting actions above.</p>
            ) : (
              logs.map((log, index) => (
