            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Select value={user.role} onValueChange={(value) => updateField('role', value)}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div>
                  ...
                  <Select value={user.status} onValueChange={(value) => updateField('status', value)}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <Alert>
                ...
                <AlertDescription>
                  <strong>Role Changes:</strong> Changing a user's role will immediately affect their access permissions. 
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  <strong>Security Notice:</strong> Any changes to security settings will be logged and may require the user to re-authenticate.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
