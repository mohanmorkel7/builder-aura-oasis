          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                {[
                  { id: 1, name: "Initial Contact", description: "First contact with the client and requirements gathering", status: "completed", completedDate: "2024-01-15", assignedTo: "Sales Team" },
                  { id: 2, name: "Requirements Analysis", description: "Detailed analysis of client needs and project scope", status: "completed", completedDate: "2024-01-18", assignedTo: "Business Analyst" },
                  { id: 3, name: "Technical Feasibility", description: "Assessment of technical requirements and feasibility", status: "completed", completedDate: "2024-01-20", assignedTo: "Tech Lead" },
                  { id: 4, name: "Proposal Preparation", description: "Creation of detailed project proposal and cost estimation", status: "completed", completedDate: "2024-01-22", assignedTo: "Project Manager" },
                  { id: 5, name: "Client Approval", description: "Final approval from client for project initiation", status: "completed", completedDate: "2024-01-25", assignedTo: "Account Manager" }
                ].slice(0, lead.total_steps || 5).map((step, index) => (
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 text-xs text-gray-500">
                            ...
                            <span>Completed: {format(new Date(step.completedDate), "MMM d, yyyy")}</span>
                          </div>
                        </div>
                      </div>
                    </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                {[
                  { id: 1, name: "Client Requirements Document", type: "PDF", size: "2.4 MB", uploadedDate: "2024-01-15", uploadedBy: "Sales Team" },
                  { id: 2, name: "Technical Specifications", type: "DOCX", size: "1.8 MB", uploadedDate: "2024-01-18", uploadedBy: "Business Analyst" },
                  { id: 3, name: "Project Proposal", type: "PDF", size: "3.2 MB", uploadedDate: "2024-01-22", uploadedBy: "Project Manager" },
                  { id: 4, name: "Budget Breakdown", type: "XLSX", size: "0.9 MB", uploadedDate: "2024-01-22", uploadedBy: "Finance Team" },
                  { id: 5, name: "Client Approval Email", type: "EML", size: "0.1 MB", uploadedDate: "2024-01-25", uploadedBy: "Account Manager" }
                ].map((doc) => (
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2 text-xs text-gray-500">
                              ...
                              <span>•</span>
                              <span>{format(new Date(doc.uploadedDate), "MMM d, yyyy")}</span>
                            </div>
                          </div>
                        </div>
            ...
            <CardContent>
              ...
              <div className="mt-3 p-3 bg-green-100 rounded-lg">
                <div className="text-sm text-green-800">
                  <strong>Handoff Package:</strong> All lead documents, client communications, and step details will be automatically transferred to the product development team.
                </div>
              </div>
            </CardContent>
          </Card>
