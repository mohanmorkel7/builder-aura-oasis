...
const mockDatabaseResponse = {
  ...
  contacts: "[{\"email\":\"mohan.morkel7@gmail.com\",\"phone\":\"+91 98765432109\",\"linkedin\":\"https://fb.com/mohanmorkel\",\"designation\":\"Director\",\"contact_name\":\"Mohan Morkel\"}]"
};
...
function simulateFrontendDisplay(lead) {
  ...
  const contactPerson = lead.contacts && 
                       lead.contacts.length > 0 && 
                       lead.contacts[0].contact_name
                         ? lead.contacts[0].contact_name
                         : "Not provided";
                         
  const email = lead.contacts &&
                lead.contacts.length > 0 &&
  ...
  const allProvided = contactPerson !== "Not provided" && 
                     email !== "Not provided" && 
                     phone !== "Not provided";
