  ...
  try {
    ...
    if (data.length > 0) {
      ...
      data.forEach((step, index) => {
        ...
        console.log(
          `${index + 1}. ${step.name}: ${prob}% (${step.status})`,
        );
      });
      ...
      if (isMockData) {
        console.log("⚠️  WARNING: This appears to be MOCK DATA, not database data");
    ...
    console.log("4. Run migration: node server/database/migrate-probability-fields.js");
