...
export const mockUsers = [
  {
    ...
    password_hash: '$2b$10$rOyZUjbEf8Z8gzLl5wF9YeS7YbZzI.sVGzJxJ8MG8KnYxRgQ8nO0y', // 'password'
    role: 'admin' as const,
...
export class MockDataService {
  ...
  static async updateClient(id: number, clientData: any) {
    ...
    this.clients[index] = { ...this.clients[index], ...clientData, updated_at: new Date().toISOString() };
  ...
  static async createDeployment(deploymentData: any) {
    const product = mockProducts.find(p => p.id === deploymentData.product_id);
    const newDeployment = {
